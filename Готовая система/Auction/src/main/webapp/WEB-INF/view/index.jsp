...
<body>
<c:if test="${empty sessionScope.role || sessionScope.role == 'SELLER' || sessionScope.role == 'USER'}">
   <header>
       <nav>
           <div class="logo">
            ...
            <c:otherwise>
                 ...
                 <section class="current-lots">
                   ...
                   <c:otherwise>
                      ...
                      <c:if test="${not empty lots && sessionScope.role != 'ADMIN'}">
                              ...
                              <div class="pagination-controls">
                                  ...
                                  <c:choose>
                                      <c:when test="${currentPage > 1}">
                                          <a href="${pageContext.request.contextPath}/index?page=${currentPage - 1}&size=${pageSize}"
                                  ...
                                  <c:forEach begin="1" end="${totalPages}" var="i">
                                      <c:choose>
                                          ...
                                          <c:otherwise>
                                              <a href="${pageContext.request.contextPath}/index?page=${i}&size=${pageSize}"
                                         class="page-link">${i}</a>
                                          </c:otherwise>
                                      </c:choose>
                                  </c:forEach>
