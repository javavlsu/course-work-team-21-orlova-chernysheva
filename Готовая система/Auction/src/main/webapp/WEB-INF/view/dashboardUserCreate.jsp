    ...
    <main class="container">
        ...
        <form action="${pageContext.request.contextPath}/admin/createUser" method="post">
            ...
            <div class="form-group">
                ...
                <div class="hint">Введите имя</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="hint">Укажите фамилия</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="hint">Укажите номер телефона</div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="login" name="login"
                       value=""  required maxlength="150">
                <div class="hint">Укажите логин</div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="password" name="password"
                       value=""  required maxlength="150">
                <div class="hint">Укажите пароль</div>
            </div>

            <div class="form-group">
                <label for="role" class="required">Роль пользователя</label>
                ...
                <div class="hint">Выберите роль пользователя</div>
            </div>
