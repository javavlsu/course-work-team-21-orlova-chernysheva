    ...
    <main class="container">
        ...
        <form>
            ...
            <div class="form-group">
                <label for="firstName" class="required">Фамилия</label>
                <input type="text" id="firstName" name="firstName"
                       value="${fn:escapeXml(user.firstName)}" required maxlength="200" readonly disabled>
            </div>

            <div class="form-group">
                <label for="lastName" class="required">Имя</label>
                <input type="text" id="lastName" name="lastName"
                       value="${fn:escapeXml(user.lastName)}" required maxlength="200" readonly disabled>
            </div>

            <div class="form-group">
                <label for="email" class="required">Email</label>
                <input type="text" id="email" name="email"
                       value="${user.email}" required maxlength="150" readonly disabled>
            </div>

            <div class="form-group">
                <label for="numberPhone">Номер телефона</label>
                <input type="number" id="numberPhone" name="numberPhone"
                       value="${user.numberPhone}"  required maxlength="150" readonly disabled>
            </div>

            <div class="form-group">
                <label for="role">Роль</label>
                <input type="text" id="role" name="role"
                       value="${user.role.role}"  required maxlength="150" readonly disabled>
            </div>
