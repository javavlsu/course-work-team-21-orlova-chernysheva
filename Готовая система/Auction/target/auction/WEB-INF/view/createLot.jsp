...
<body>
   <header>
    ...
    <main class="container">
        ...
        <form action="${pageContext.request.contextPath}/createLot" method="post">
            <div class="form-group">
                <label for="title" class="required">Название картины</label>
                <input type="text" id="title" name="title"
                       placeholder="Например: «Звёздная ночь над Роной»" required maxlength="200">
            ...
            <div class="form-group">
                ...
                <input type="text" id="author" name="author"
                       placeholder="Например: Винсент ван Гог" required maxlength="150">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description"
                          placeholder="Опишите картину: стиль, техника, год создания, размеры, история и т. д."
            ...
            <div class="form-group">
                <label for="startPrice" class="required">Начальная цена (руб.)</label>
                <input type="number" id="startPrice" name="startPrice"
                       step="0.01" min="0.01" placeholder="0.00" required>
                <div class="hint">Минимальная цена, с которой начнутся торги</div>
            </div>
