...
<body>
    <main class="container">
        <h2>Создание нового аукциона(каталога)</h2>
        <form action="${pageContext.request.contextPath}/admin/createAuction" method="post">
            ...
            <div class="form-group">
                <label for="startTime" class="required">Начало</label>
